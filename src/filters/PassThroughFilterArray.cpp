...
namespace pointcloud2_filters
{
  class PassThroughFilterArray : public filters::FilterBase<sensor_msgs::msg::PointCloud2>
  {
    ...
    public:
      ...
      bool configure()
      {
        RCLCPP_INFO(this->logging_interface_->get_logger(),"Pointcloud2PassThroughFilterArray configuring");
...
PLUGINLIB_EXPORT_CLASS(pointcloud2_filters::PassThroughFilterArray, filters::FilterBase<sensor_msgs::msg::PointCloud2>)
